...
CMD1="\n please remove all the print statements from scripts/mini_terminal.py"
...
printf "$STR_TO_OUTPUT" | uv run python -m examples.interactive gemini --experimental-acp --yolo --allowed-tools run_shell_command -m gemini-2.5-pro
